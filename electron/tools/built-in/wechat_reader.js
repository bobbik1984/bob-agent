...
class WechatReaderTool extends BaseTool {
  constructor() {
    super();
    this.name = 'wechat_reader';
    this.description = '专门用于读取微信公众号文章正文内容的工具。当需要分析或获取 mp.weixin.qq.com 的文章时，必须使用此工具，它可以自动绕过微信的防爬环境检测。';
    this.input_schema = {
      type: 'object',
      properties: {
        url: {
...
module.exports = new WechatReaderTool();
